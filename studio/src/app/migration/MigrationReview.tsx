    ...
    setCompetition((current) =>
      current
        ? {
            ...current,
            [field]:
              parsed === null || Number.isFinite(parsed) ? parsed : current[field],
          }
        : current,
    );
  };
            ...
            <section className="panel">
              ...
              <div className="migration-form-grid">
                ...
                <label className="field field-wide">
                  <span>Plats</span>
                  <input
                    value={competition.location ?? eventor?.location ?? ""}
              ...
              <dl className="migration-facts">
                ...
                <div><dt>Kartcentrum</dt><dd>{competition.latitude !== null && competition.longitude !== null ? `${competition.latitude}, ${competition.longitude}` : "—"}</dd></div>
