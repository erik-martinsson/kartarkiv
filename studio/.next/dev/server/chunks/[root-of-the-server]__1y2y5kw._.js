...
"[project]/studio/src/app/api/migration/doma/[mapId]/publish/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    ...
    let reviewed;
    try {
        reviewed = JSON.parse(await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["readFile"])(reviewedFile, "utf8"));
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Granskningsfilen kunde inte läsas: ${errorMessage(error)}`
        }, {
            status: 500
        });
    }
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$scripts$2f$lib$2f$published_reviewed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publishReviewed"])(reviewed, {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            markdown: __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].relative(repositoryRoot, result.markdownPath),
            publicId: result.markdownPublicId,
            assets: result.assets.map((asset)=>({
                    kind: asset.kind,
                    path: __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].relative(repositoryRoot, asset.diskPath),
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$scripts$2f$lib$2f$published_reviewed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PublishTargetExistsError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Tävlingen är redan publicerad. Bekräfta överskrivning för att fortsätta.",
                code: "target-exists",
                existingTargets: error.targets.map((target)=>__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].relative(repositoryRoot, target))
            }, {
                status: 409
            });
        }
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$scripts$2f$lib$2f$published_reviewed$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PublishValidationError"]) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message,
        ...
        console.error(`Kunde inte publicera DOMA ${mapId}:`, error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$studio$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: `Publiceringen misslyckades: ${errorMessage(error)}`,
            code: "publish-error"
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1y2y5kw._.js.map