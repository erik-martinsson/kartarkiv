module.exports = [
"[project]/studio/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/fetch/global.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/encoding/index.js [app-route] (ecmascript)");
/**
...
"[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { forgivingBase64, collectASequenceOfCodePoints, collectASequenceOfCodePointsFast, isomorphicDecode, removeASCIIWhitespace, removeChars } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { types, inspect } = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)");
const { runtimeFeatures } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
const UNDEFINED = 1;
const BOOLEAN = 2;
const STRING = 3;
const SYMBOL = 4;
...
"[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { redirectStatusSet, referrerPolicyTokens, badPortsSet } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)");
const { getGlobalOrigin } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/global.js [app-route] (ecmascript)");
const { collectAnHTTPQuotedString, parseMIMEType } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { performance } = __turbopack_context__.r("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)");
const { ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isUint8Array } = __turbopack_context__.r("[externals]/node:util/types [external] (node:util/types, cjs)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { isomorphicEncode, collectASequenceOfCodePoints, removeChars } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { iteratorMixin } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/formdata-parser.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { HTTP_TOKEN_CODEPOINTS } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { makeEntry } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isomorphicDecode } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const util = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { ReadableStreamFrom, readableStreamClose, fullyReadBody, extractMimeType } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { FormData, setFormDataState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/formdata.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isErrored, isDisturbed } = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const { isUint8Array } = __turbopack_context__.r("[externals]/node:util/types [external] (node:util/types, cjs)");
const { serializeAMimeType } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { multipartFormDataParser } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/formdata-parser.js [app-route] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { parseJSONFromBytes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/encoding/index.js [app-route] (ecmascript)");
const { runtimeFeatures } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

// https://github.com/Ethan-Arrowood/undici-fetch
const { kConstruct } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { iteratorMixin, isValidHeaderName, isValidHeaderValue } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { Headers, HeadersList, fill, getHeadersGuard, setHeadersGuard, setHeadersList } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
const { extractBody, cloneBody, mixinBody, streamRegistry, bodyUnusable } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const nodeUtil = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)");
const { kEnumerableProperty } = util;
const { isValidReasonPhrase, isCancelled, isAborted, isErrorLike, environmentSettingsObject: relevantRealm } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { redirectStatusSet, nullBodyStatus } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { URLSerializer } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { kConstruct } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { isomorphicEncode, serializeJavascriptValueToJSONString } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/* globals AbortController */ const { extractBody, mixinBody, cloneBody, bodyUnusable } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)");
const { Headers, fill: fillHeaders, HeadersList, setHeadersGuard, getHeadersGuard, setHeadersList, getHeadersList } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
const util = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const nodeUtil = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)");
const { isValidHTTPToken, sameOrigin, environmentSettingsObject } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { forbiddenMethodsSet, corsSafeListedMethodsSet, referrerPolicy, requestRedirect, requestMode, requestCredentials, requestCache, requestDuplex } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/fetch/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

// https://github.com/Ethan-Arrowood/undici-fetch
const { makeNetworkError, makeAppropriateNetworkError, filterResponse, makeResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)");
const { HeadersList } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
const { Request, cloneRequest, getRequestDispatcher, getRequestState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const zlib = __turbopack_context__.r("[externals]/node:zlib [external] (node:zlib, cjs)");
const { makePolicyContainer, clonePolicyContainer, requestBadPort, TAOCheck, appendRequestOriginHeader, responseLocationURL, requestCurrentURL, setRequestReferrerPolicyOnRedirect, tryUpgradeRequestToAPotentiallyTrustworthyURL, createOpaqueTimingInfo, appendFetchMetadata, corsCheck, crossOriginResourcePolicyCheck, determineRequestsReferrer, coarsenedSharedCurrentTime, sameOrigin, isCancelled, isAborted, isErrorLike, fullyReadBody, readableStreamClose, urlIsLocal, urlIsHttpHttpsScheme, urlHasHttpsScheme, clampAndCoarsenConnectionTimingInfo, simpleRangeHeaderValue, buildContentRange, createInflate, extractMimeType, hasAuthenticationEntry, includesCredentials, isTraversableNavigable } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { safelyExtractBody, extractBody } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/body.js [app-route] (ecmascript)");
const { redirectStatusSet, nullBodyStatus, safeMethodsSet, requestBodyHeader, subresourceSet } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/constants.js [app-route] (ecmascript)");
...
const { addAbortListener, bufferToLowerCasedHeaderName } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { dataURLProcessor, serializeAMimeType, minimizeSupportedMimeType } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { getGlobalDispatcher } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/global.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { STATUS_CODES } = __turbopack_context__.r("[externals]/node:http [external] (node:http, cjs)");
const { bytesMatch } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/subresource-integrity/subresource-integrity.js [app-route] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { isomorphicEncode } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
const { runtimeFeatures } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/cache/util.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { URLSerializer } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { isValidHeaderName } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
/**
...
"[project]/studio/node_modules/undici/lib/web/cache/cache.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { kConstruct } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { urlEquals, getFieldValues } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cache/util.js [app-route] (ecmascript)");
const { kEnumerableProperty, isDisturbed } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { cloneResponse, fromInnerResponse, getResponseState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)");
const { Request, fromInnerRequest, getRequestState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const { fetching } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/index.js [app-route] (ecmascript)");
const { urlIsHttpHttpsScheme, readAllBytes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { createDeferredPromise } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
/**
...
"[project]/studio/node_modules/undici/lib/web/cache/cachestorage.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { Cache } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cache/cache.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { kConstruct } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
class CacheStorage {
...
"[project]/studio/node_modules/undici/lib/web/cookies/constants.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/cookies/util.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/cookies/parse.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { collectASequenceOfCodePointsFast } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
const { maxNameValuePairSize, maxAttributeValueSize } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cookies/constants.js [app-route] (ecmascript)");
const { isCTLExcludingHtab } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cookies/util.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
/**
...
"[project]/studio/node_modules/undici/lib/web/cookies/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { parseSetCookie } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cookies/parse.js [app-route] (ecmascript)");
const { stringify } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/cookies/util.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { Headers } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/events.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { states, opcodes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { isUtf8 } = __turbopack_context__.r("[externals]/node:buffer [external] (node:buffer, cjs)");
const { removeHTTPWhitespace } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { collectASequenceOfCodePointsFast } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/infra/index.js [app-route] (ecmascript)");
/**
...
"[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { runtimeFeatures } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
const { maxUnsigned16Bit, opcodes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { uid, states, sentCloseFrameState, emptyBuffer, opcodes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { parseExtensions, isClosed, isClosing, isEstablished, isConnecting, validateCloseCodeAndReason } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { makeRequest } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const { fetching } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/index.js [app-route] (ecmascript)");
const { Headers, getHeadersList } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/headers.js [app-route] (ecmascript)");
const { getDecodeSplit } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { runtimeFeatures } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/runtime-features.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/permessage-deflate.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { createInflateRaw, Z_DEFAULT_WINDOWBITS } = __turbopack_context__.r("[externals]/node:zlib [external] (node:zlib, cjs)");
const { isValidClientWindowBits } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { MessageSizeExceededError } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/receiver.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { Writable } = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const assert = __turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)");
const { parserStates, opcodes, states, emptyBuffer, sentCloseFrameState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { isValidStatusCode, isValidOpcode, websocketMessageReceived, utf8Decode, isControlFrame, isTextBinaryFrame, isContinuationFrame } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { failWebsocketConnection } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
const { PerMessageDeflate } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/permessage-deflate.js [app-route] (ecmascript)");
const { MessageSizeExceededError } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/errors.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/sender.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { WebsocketFrameSend } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
const { opcodes, sendHints } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const FixedQueue = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/dispatcher/fixed-queue.js [app-route] (ecmascript)");
/**
...
"[project]/studio/node_modules/undici/lib/web/websocket/websocket.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { isArrayBuffer } = __turbopack_context__.r("[externals]/node:util/types [external] (node:util/types, cjs)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { URLSerializer } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { staticPropertyDescriptors, states, sentCloseFrameState, sendHints, opcodes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { isConnecting, isEstablished, isClosing, isClosed, isValidSubprotocol, fireEvent, utf8Decode, toArrayBuffer, getURLRecord } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { establishWebSocketConnection, closeWebSocketConnection, failWebsocketConnection } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
const { ByteParser } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/receiver.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { getGlobalDispatcher } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/global.js [app-route] (ecmascript)");
const { ErrorEvent, CloseEvent, createFastMessageEvent } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/events.js [app-route] (ecmascript)");
const { SendQueue } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/sender.js [app-route] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { validateCloseCodeAndReason } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { kConstruct } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/symbols.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/websocket/stream/websocketstream.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { createDeferredPromise } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/util/promise.js [app-route] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
const { states, opcodes, sentCloseFrameState } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/constants.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { getURLRecord, isValidSubprotocol, isEstablished, utf8Decode } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/util.js [app-route] (ecmascript)");
const { establishWebSocketConnection, failWebsocketConnection, closeWebSocketConnection } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/connection.js [app-route] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/diagnostics.js [app-route] (ecmascript)");
const { WebsocketFrameSend } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/frame.js [app-route] (ecmascript)");
const { ByteParser } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/receiver.js [app-route] (ecmascript)");
const { WebSocketError, createUnvalidatedWebSocketError } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/stream/websocketerror.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { utf8DecodeBytes } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/encoding/index.js [app-route] (ecmascript)");
...
"[project]/studio/node_modules/undici/lib/web/eventsource/util.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/studio/node_modules/undici/lib/web/eventsource/eventsource-stream.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { Transform } = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const { isASCIINumber, isValidLastEventId } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/eventsource/util.js [app-route] (ecmascript)");
/**
 * @type {number[]} BOM
 */ const BOM = [
    0xEF,
...
"[project]/studio/node_modules/undici/lib/web/eventsource/eventsource.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { makeRequest } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/request.js [app-route] (ecmascript)");
const { webidl } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/webidl/index.js [app-route] (ecmascript)");
const { EventSourceStream } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/eventsource/eventsource-stream.js [app-route] (ecmascript)");
const { parseMIMEType } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/data-url.js [app-route] (ecmascript)");
const { createFastMessageEvent } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/websocket/events.js [app-route] (ecmascript)");
const { isNetworkError } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/response.js [app-route] (ecmascript)");
const { kEnumerableProperty } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/core/util.js [app-route] (ecmascript)");
const { environmentSettingsObject } = __turbopack_context__.r("[project]/studio/node_modules/undici/lib/web/fetch/util.js [app-route] (ecmascript)");
...
//# sourceMappingURL=0406_undici_lib_web_177m_ok._.js.map